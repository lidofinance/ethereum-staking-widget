export class CloudFlareStorage {
  constructor(token, accountId, kvNamespace) {
    this.token = token;
  ...
  url(key) {
    return `https://api.cloudflare.com/client/v4/accounts/${this.accountId}/storage/kv/namespaces/${this.kvNamespace}/values/${key}`;
  }
}
