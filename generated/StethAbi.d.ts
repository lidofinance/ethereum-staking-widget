...
interface StethAbiInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'SET_INSURANCE_FUND',
    values?: undefined,
  ): string;
...
export class StethAbi extends BaseContract {
  ...
  filters: {
    ...
    FeeSet(
      feeBasisPoints?: null,
    ): TypedEventFilter<[number], { feeBasisPoints: number }>;
    ...
    ): TypedEventFilter<[string], { withdrawalCredentials: string }>;
    ...
    Submitted(
      ...
      { sender: string; amount: BigNumber; referral: string }
    >;
