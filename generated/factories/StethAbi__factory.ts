...
import type { StethAbi, StethAbiInterface } from '../StethAbi';
...
export class StethAbi__factory {
  static readonly abi = _abi;
  static createInterface(): StethAbiInterface {
    return new utils.Interface(_abi) as StethAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): StethAbi {
    return new Contract(address, _abi, signerOrProvider) as StethAbi;
  }
}
