  ...
  return (
    ...
    >
      <InputGroupStyled fullwidth>
        ...
        >
          <Option
            data-testid="stEthTokenOption"
            leftDecorator={iconsMap[TOKENS.STETH]}
            value={TOKENS.STETH}
          >
            {`Lido (${getTokenDisplayName(TOKENS.STETH)})`}
          </Option>
          <Option
            data-testid="ethTokenOption"
            leftDecorator={iconsMap[ETH]}
            value={ETH}
          >
            Ethereum (ETH)
          </Option>
      ...
      {active ? (
        needsApprove && selectedToken === TOKENS.STETH ? (
          ...
          <Button data-testid="wrapBtn" {...buttonProps}>
            Wrap
          </Button>
        )
      ) : (
