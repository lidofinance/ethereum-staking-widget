...
export const ETH_VAULT_DEPOSABLE_TOKENS_MAIN = [
  TOKEN_SYMBOLS.eth,
  TOKEN_SYMBOLS.weth,
...
export const ETH_VAULT_DEPOSABLE_TOKENS_UPGRADABLE = [
  TOKEN_SYMBOLS.gg,
  TOKEN_SYMBOLS.streth,
  TOKEN_SYMBOLS.dvsteth,
] as const;

export const ETH_VAULT_DEPOSABLE_TOKENS = [
  ...ETH_VAULT_DEPOSABLE_TOKENS_MAIN,
  ...ETH_VAULT_DEPOSABLE_TOKENS_UPGRADABLE,
] as const;

export const ETH_VAULT_QUERY_KEY = 'earn-vault-eth';
