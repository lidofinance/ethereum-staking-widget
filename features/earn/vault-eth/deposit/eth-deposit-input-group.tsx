...
import { useETHDepositEthGasLimit } from './hooks/use-eth-deposit-eth-gas-limit';
...
const OPTIONS = ETH_DEPOSABLE_TOKENS.map((token) => ({ token }));

export const ETHDepositInputGroup = () => {
