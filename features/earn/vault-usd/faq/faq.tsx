...
const FAQ_IDS = {
  ...
  usdcWithdrawal: 'faq-usdc-withdrawal',
  fee: 'faq-deposit-withdraw-fee',
  pendingWithdrawal: 'faq-pending-withdrawal-rewards',
  ...
  return (
    <FaqGroup activeItemHash={activeItemHash}>
      <Section data-testid="vault-faq">
        <WhatIsEarnUsd defaultExpanded />
        <WhatIsApyForEarnUsd id={FAQ_IDS.apy} />
        ...
        <WhyReceiveUsdcOnWithdrawal id={FAQ_IDS.usdcWithdrawal} />
