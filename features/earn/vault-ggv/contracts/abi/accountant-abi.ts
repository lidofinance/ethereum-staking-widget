export const GGV_ACCOUNTANT_ABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'newFeesOwedInBase', type: 'uint256' },
      { internalType: 'uint256', name: 'totalFeesOwedInBase', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint16', name: 'platformFee', type: 'uint16' }],
