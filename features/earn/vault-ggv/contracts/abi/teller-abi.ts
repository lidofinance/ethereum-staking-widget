export const GGV_TELLER_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint112', name: 'cap', type: 'uint112' },
    ],
    name: 'DepositCapSet',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bool', name: 'denyFrom', type: 'bool' },
      { internalType: 'bool', name: 'denyTo', type: 'bool' },
      { internalType: 'bool', name: 'denyOperator', type: 'bool' },
      { internalType: 'bool', name: 'permissionedOperator', type: 'bool' },
      { internalType: 'uint256', name: 'shareUnlockTime', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint112', name: 'cap', type: 'uint112' }],
    name: 'setDepositCap',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'bool', name: '_permissionedTransfers', type: 'bool' },
    ],
