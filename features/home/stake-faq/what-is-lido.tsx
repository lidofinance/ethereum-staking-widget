...
import { FaqItemStyled } from './styles';
  ...
  return (
    <Accordion defaultExpanded summary={TITLE}>
      <FaqItemStyled>
        ...
        <p>
          As part of our continuing efforts to be a force for decentralization,
          we have published a [scorecard](https://lido.fi/scorecard) for
