 ...
 * prefixed) and never populates process.env, which buildClientEnv()
 * (config/client-env-manifest.ts) reads — import this before anything that
 * might read env at module init.
 *
