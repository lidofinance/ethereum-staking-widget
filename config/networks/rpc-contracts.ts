...
// Concrete abi module, NOT the cowswap feature barrel (which exports React
// components) — this file must stay importable by the api server.
import {
  CowSettlementAbi,
  CowVaultRelayerAbi,
} from 'features/dex-withdrawals/cowswap/abi';
// Tokens ABIs
...
// Framework-neutral env (NOT the `config` barrel): this module feeds the
// api server's RPC allowlists AND its eth_call metrics decoding. Formerly
// `utilsApi/contractAddressesMetricsMap.ts`.
...
export const METRIC_CONTRACT_ABIS = {
  ...
  [CONTRACT_NAMES.ethRedeemQueueWSTETH]: ASYNC_REDEEM_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncRedeemQueueWSTETH]: SYNC_REDEEM_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueETH]: SYNC_DEPOSIT_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueWETH]: SYNC_DEPOSIT_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueWSTETH]: SYNC_DEPOSIT_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueGG]: SYNC_DEPOSIT_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueSTRETH]: SYNC_DEPOSIT_QUEUE_ABI,
  [CONTRACT_NAMES.ethSyncDepositQueueDVSTETH]: SYNC_DEPOSIT_QUEUE_ABI,
  ...
  [CONTRACT_NAMES.usdRedeemQueueUSDC]: ASYNC_REDEEM_QUEUE_ABI,
  [CONTRACT_NAMES.usdRedeemQueueUSDT]: ASYNC_REDEEM_QUEUE_ABI,
  [CONTRACT_NAMES.usdSyncRedeemQueueUSDC]: SYNC_REDEEM_QUEUE_ABI,
...
const supportedChainsWithMainnet: CHAINS[] = dynamics.supportedChains.includes(
  CHAINS.Mainnet,
)
  ? dynamics.supportedChains
  : [...dynamics.supportedChains, CHAINS.Mainnet];
